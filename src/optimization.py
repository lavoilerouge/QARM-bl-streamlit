...
def get_market_caps_for_date(tickers, rebalance_date, px_prices=None):
    ...
    for ticker in tickers:
        try:
            ...
            # Fallback: try px_prices (note: this might be adjusted prices)
            if price is None and px_prices is not None and rebalance_date is not None and ticker in px_prices.columns:
